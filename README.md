...
## Environments
- Preview: https://main--boilerplate-forms--creid-play.hlx.page/
- Live: https://main--boilerplate-forms--creid-play.hlx.live/
...
1. Open the `boilerplate-forms` directory in your favorite IDE and start coding :)
